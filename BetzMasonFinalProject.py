...
# Adding an image to the welcome page (Milkshake Image)
milkshake_image = tk.PhotoImage(file="milkshake.png")  # Replace with the path to your milkshake image
milkshake_label = tk.Label(welcome_page, image=milkshake_image)
milkshake_label.pack(pady=10)
...
# Adding an image to the ordering page (Ice Cream Image)
ice_cream_image = tk.PhotoImage(file="icecream.png")  # Replace with the path to your ice cream image
ice_cream_label = tk.Label(ordering_page, image=ice_cream_image)
ice_cream_label.pack(pady=10)
